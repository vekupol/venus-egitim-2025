      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          const classHomeworks = userHomeworks.filter(
            (homework) => homework.classUid === classUid
          );
        ...
        <Container>
          ...
          <div>
            <Homeworks>
              <ClassRanking
                classUid={classUid}
                currentUserUid={belirliKullaniciUID}
              />
            </Homeworks>
          </div>
        </Container>
